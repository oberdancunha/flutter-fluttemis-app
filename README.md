...
Visualmente e em termos comportamentais, a comparação entre as três plataformas apresentou um alto nível de fidelidade entre elas, mostrando que não é apenas no mobile que o flutter faz um belíssmo trabalho de cross-platform, mas no desktop também.
